...
AgenderFrame::AgenderFrame(wxLocale& locale,wxString cfgFile):m_locale(locale)
{
    ...
    FlexGridSizer1->Add(CalendarCtrl1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5);
	ListBox1 = new wxListBox(this, ID_LISTBOX1, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LISTBOX1"));
    FlexGridSizer1->Add(ListBox1, 1, wxALL|wxEXPAND, 5);
	...
	BtnNuevo->SetDefault();
	BtnNuevo->SetFocus();
    BoxSizer1->Add(BtnNuevo, 1, wxALL|wxEXPAND, 0);
    ...
    BoxSizer1->Add(BtnElim, 1, wxALL|wxEXPAND, 0);
	Button3 = new wxButton(this, wxID_ABOUT, _("&About..."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("wxID_ABOUT"));
    BoxSizer1->Add(Button3, 1, wxALL|wxEXPAND, 0);
    FlexGridSizer1->Add(BoxSizer1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5);
